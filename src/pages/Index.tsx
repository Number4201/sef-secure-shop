      ...
      <div className="fixed bottom-8 right-8 z-50">
        <Dialog>
          <DialogTrigger asChild>
            <Button 
              size="lg" 
              className="bg-[#ea384c] hover:bg-[#c52435] text-white font-bold px-6 py-6 rounded-full shadow-2xl border-2 border-white animate-pulse hover:animate-none transition-all duration-300 hover:scale-105"
            >
